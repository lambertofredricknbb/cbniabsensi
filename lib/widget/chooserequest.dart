...
class ChooseRequestWidget extends StatefulWidget {
  @override
  _ChooseRequestWidget createState() => _ChooseRequestWidget();
}

class _ChooseRequestWidget extends State<ChooseRequestWidget> {
  ...
  Future<String> getData() async {
    ...
    var response = await http.post(
      Uri.encodeFull("http://202.137.6.90:8084/cbni-intranet/attendance/getpermissions2"),
      headers: {
