...
class ListPermohonanPage extends StatefulWidget {
  @override
  _ListPermohonanPageState createState() => _ListPermohonanPageState();
}

class _ListPermohonanPageState extends State<ListPermohonanPage> {
  ...
  Future<String> getData() async {
    ...
    var response = await http.post(
      Uri.encodeFull("http://202.137.6.90:8084/test/getpermissions2.php"),
      headers: {
